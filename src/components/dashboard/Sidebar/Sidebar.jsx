...
export default function CyberCafeSidebar() {
        ...
        <div className="w-80 h-screen bg-white shadow-lg flex flex-col">
            <div className="p-6 border-b border-gray-100">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800">CyberCafe Manager</h1>
                </div>

                <div className="flex flex-col items-center">
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-amber-200 to-amber-300 flex items-center justify-center mb-4 shadow-md">
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-full flex items-center gap-4 px-6 py-4 rounded-xl mb-2 transition-all duration-200 ${
                                isActive
